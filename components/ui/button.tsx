  ...
  return (
    <button
      className={cn(
        ...
        "focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-brand-clay focus-visible:ring-offset-2",
        ...
        !success &&
          variant === "primary" &&
          "bg-brand-clay text-white hover:bg-brand-clay-hover",
        !success &&
          variant === "secondary" &&
